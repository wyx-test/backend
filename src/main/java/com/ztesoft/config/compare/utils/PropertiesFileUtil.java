...
public class PropertiesFileUtil {
    ...
    public static List<ContentValueInfo> compareProperties(String sourceFile, String targetFile) {
        ...
        for (String key : totalSet) {
            ...
            if (targetValue != null && sourceValue != null) {
                contentValueInfo.setStatus(targetValue.equals(sourceValue) ? 0 : -1);
    ...
    public static Map<String, String> getPropertyMap(String file) {
        ...
        try {
            ...
            DataInputStream in = new DataInputStream(fileInputStream);
//            BufferedReader br = new BufferedReader(new InputStreamReader(in));
            BufferedReader br = new BufferedReader(new InputStreamReader(in,Charset.forName(FileUtil.getFileEncoding(file))));
            String strLine;
            while ((strLine = br.readLine()) != null) {
                //过滤注释
